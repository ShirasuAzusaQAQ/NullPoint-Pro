...
public class ModuleManager implements Wrapper {
	...
	public ModuleManager() {
        ...
        addModule(new BurrowPro());
		addModule(new AutoCityDown());
		...
		addModule(new WebAuraPro());
		addModule(new XCarry());
		addModule(new AutoClearHead());
		addModule(new AutoCityMax());
		...
		addModule(new AutoShot());
		addModule(new PullUp());
        addModule(new Kill());
