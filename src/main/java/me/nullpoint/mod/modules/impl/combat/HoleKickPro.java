...
public class HoleKickPro extends Module {
    ...
    public static HoleKickPro INSTANCE;
    private final BooleanSetting pistonPacket = add(new BooleanSetting("PistonPacket", true));
    ...
    public HoleKickPro() {
        super("HoleKickPro", Category.Combat);
        INSTANCE = this;
    }
