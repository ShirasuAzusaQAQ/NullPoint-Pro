...
public class AutoTrapPro
    ...
    public static AutoTrapPro INSTANCE;

    public AutoTrapPro() {
        super("AutoTrapPro", "Automatically trap the enemy", Category.Combat);
        INSTANCE = this;
    ...
    public class AutoTrapRender {
        ...
        public static class placePosition {
            ...
            public placePosition(BlockPos placePos) {
                this.firstFade = new FadeUtils((long) AutoTrapPro.INSTANCE.fadeTime.getValue());
                this.pos = placePos;
                this.posColor = AutoTrapPro.INSTANCE.color.getValue();
